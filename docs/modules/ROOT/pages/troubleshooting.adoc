...
1.  Enable the 'Enable logging to temporary folder' checkbox.
2.  Later, to find the log files, click the 'Open folder' button.
3.  Select the logs for the time frame in which the issue occurred.
